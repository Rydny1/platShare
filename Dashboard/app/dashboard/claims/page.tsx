...
export default function ClaimsPage() {
  return (
    <div className="space-y-7">
      ...
      <section className="overflow-hidden border-y border-border" aria-labelledby="todays-claims-heading">
        <div className="border-b border-border py-5"><h2 id="todays-claims-heading" className="text-base font-semibold">Today</h2><p className="mt-1 text-sm text-muted-foreground">{recentClaims.length} recent claims</p></div>
